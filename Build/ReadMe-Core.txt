...
1. Manually compress/minify and/or bundle any Css and/or Js. This is tedious
   ...
   Sample video explaining this:


2. Install-Package YUICompressor.NET - take advantage of the build in compression and bundling that has come
   with ASP.NET MVC3 -but- instead of using the stock compression with ASP.NET, use this titty-sparkly
